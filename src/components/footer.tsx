...
export default function Footer(){
    ...
    return(
        <footer>
            <svg xmlns="" className="-mb-0.5 w-full" viewBox="0 0 1367.743 181.155">
                <path
            ...
            <div className="bg-gradient-to-b from-gray-100 to-transparent dark:from-gray-800 dark:to-transparent pt-1">
                <div className="container m-auto space-y-8 px-6 text-gray-600 dark:text-gray-400 md:px-12 lg:px-20">
                    <div className="grid grid-cols-8 gap-6 md:gap-0">
                        <div
                            className="col-span-8 border-r border-gray-100 dark:border-gray-800 md:col-span-2 lg:col-span-3">
                            <div
                        ...
                        <div className="col-span-8 md:col-span-6 lg:col-span-5">
                            ...
                            <div
                                className="flex justify-between border-t border-gray-100 dark:border-gray-800 py-4 pb-8 md:pl-16">
                                <span> AITU 2024 <span id="year"></span> </span>
